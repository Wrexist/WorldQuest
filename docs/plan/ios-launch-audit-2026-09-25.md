...
| 11 | P0 | Connected multi-day journey test on real workerd | E10/E11 | ✅ `pnpm e2e:d1` 31/31 on the real bundle and real Worker: online, streak beat, server quest, offline ticket, reconnect sync, ledger; then link, a second phone signing in, both phones learning on one account, sign-out, sign-in again and deletion. Concurrent submission (E11) still open |
